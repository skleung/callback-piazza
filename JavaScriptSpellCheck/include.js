...
if(wm=="jquery.ui"&&typeof(jQuery)&&typeof($.ui)){if(!$('#livespell_jquery_ui_modal_frame').length){$("body").append("<div id='livespell_jquery_ui_modal'><iframe width='"+Dwidth+"' height='"+Dheight+"' scrolling='no' marginwidth='0' marginheight='0' frameborder=0 id='livespell_jquery_ui_modal_frame' src='about:blank'></iframe></div>");}
var f=this
var u=this.url();var ttl=livespell.lang.fetch(this.id(),"WIN_TITLE")
$("#livespell_jquery_ui_modal").dialog({autoOpen:true,modal:true,closeOnEscape:true,title:ttl,width:490,height:350,open:function(ev,ui){f["onDialogOpen"]()
$('#livespell_jquery_ui_modal_frame').attr('src',u);},close:function(){f["onDialogClose"]()}});return;}
...
ret+="\n";}}}
return ret;},getProxyText:function(id){var me=livespell.insitu.proxyDOM(id);var val=livespell.insitu.extractTextWithWhitespace(me)
